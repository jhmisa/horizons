...
type BookCopy = {
  ...
  includedReportDesc: string;
  includedWalkthroughDesc: string;
  consultationVideoCallTitle: string;
};

const COPY: Record<Country, BookCopy> = {
  nz: {
    heroPill: "STEP 2: BOOK YOUR CONSULTATION",
    h1: "Book Your LIA Consultation",
    heroSubtext:
      "One-on-one session with a Licensed Immigration Adviser. Pay $197 USD and we'll handle the rest.",
    pricingCardSubhead: "1-Hour Video Call with an LIA",
    includedReportDesc:
      "Your best pathway to New Zealand, documented in detail.",
    includedWalkthroughDesc:
      "Your LIA explains the report's findings, section by section.",
    consultationVideoCallTitle: "Your LIA video call (1 hour)",
  },
  au: {
    heroPill: "STEP 2: BOOK YOUR CONSULTATION",
    h1: "Book Your Australia Consultation",
    heroSubtext:
      "One-on-one session with our migration team. Pay $197 USD and we'll handle the rest.",
    pricingCardSubhead: "1-Hour Video Call with our team",
    includedReportDesc:
      "Your best pathway to Australia, documented in detail.",
    includedWalkthroughDesc:
      "Your adviser explains the report's findings, section by section.",
    consultationVideoCallTitle: "Your consultation video call (1 hour)",
  },
  ca: {
    heroPill: "STEP 2: BOOK YOUR CONSULTATION",
    h1: "Book Your Canada Consultation",
    heroSubtext:
      "One-on-one session with our migration team. Pay $197 USD and we'll handle the rest.",
    pricingCardSubhead: "1-Hour Video Call with our team",
    includedReportDesc:
      "Your best pathway to Canada, documented in detail.",
    includedWalkthroughDesc:
      "Your adviser explains the report's findings, section by section.",
    consultationVideoCallTitle: "Your consultation video call (1 hour)",
  },
...
export default function BookPage({ country }: { country: Country }) {
                ...
                {[
                  {
                    ...
                    desc: copy.includedReportDesc,
                  },
                  {
                    icon: "fa-list-check",
                    title: "Step-by-Step Walkthrough",
                    desc: copy.includedWalkthroughDesc,
                  },
                  {
                    icon: "fa-comments",
                    title: "Live Q&A",
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <ol className="space-y-6">
            {[
              ...
              {
                num: 4,
                title: copy.consultationVideoCallTitle,
                desc:
                  country === "nz"
                    ? "One-on-one with a Licensed Immigration Adviser."
                    : "One-on-one with our migration team.",
              },
            ].map((item) => (
          ...
          <p className="mt-10 text-center text-sm text-accent-500">
            ...
            <Link
              href={country === "au" ? "/au/answers" : "/answers"}
